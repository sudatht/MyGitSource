...
Public Function regDeleteSubKey(ByVal lngRootKey As Long, _
...
'
' Syntax:
'    regDeleteSubKey HKEY_CURRENT_USER, _
...
' --------------------------------------------------------------
  If regDoesKeyExist(lngRootKey, strRegKeyPath) Then
...
Public Function regDoesKeyExist(ByVal lngRootKey As Long, _
...
'
' Syntax:
'    strKeyQuery = regQueryAKey(HKEY_CURRENT_USER, _
...
' --------------------------------------------------------------
  If lngKeyHandle = 0 Then
      regDoesKeyExist = False
  Else
      regDoesKeyExist = True
  End If
...
Public Function regQueryAKey(ByVal lngRootKey As Long, _
                               ByVal strRegKeyPath As String, _
         ...
         Case REG_SZ:       ' String data (most common)
              ...
              Else
                  ...
                  If intPosition > 0 Then
                      ...
                      regQueryAKey = Left(strBuffer, intPosition - 1)
                  Else
                      ' did not find one.  Save everything.
                      regQueryAKey = strBuffer
                  End If
              End If
...
End Function
Public Sub regCreateKeyValue(ByVal lngRootKey As Long, ByVal strRegKeyPath As String, _
...
'
' Syntax:
'    regCreateKeyValue HKEY_CURRENT_USER, _
'                      "Software\AAA-Registry Test\Products", _
...
End Sub
Public Function regCreateAKey(ByVal lngRootKey As Long, ByVal strRegKeyPath As String)
...
'
' Syntax:
'   regCreateAKey HKEY_CURRENT_USER, "Software\AAA-Registry Test"
'   regCreateAKey HKEY_CURRENT_USER, "Software\AAA-Registry Test\Products"
' --------------------------------------------------------------
...
End Function
Public Function regDeleteAKey(ByVal lngRootKey As Long, _
                                ByVal strRegKeyPath As String, _
...
'
' Syntax:
'    regDeleteAKey HKEY_CURRENT_USER, "Software", "AAA-Registry Test"
'
...
' --------------------------------------------------------------
  If regDoesKeyExist(lngRootKey, strRegKeyPath) Then
      ...
      If m_lngRetVal = 0 Then regDeleteAKey = True
...
' --------------------------------------------------------------
  If Not regDoesKeyExist(lngRootKey, "Software\AAA-Registry Test") Then
      ' create the main key and the first sub key
      regCreateAKey lngRootKey, "Software\AAA-Registry Test"
      regCreateAKey lngRootKey, "Software\AAA-Registry Test\Products"
  End If
      
' --------------------------------------------------------------
' see if the next sub key exist.
' --------------------------------------------------------------
  If Not regDoesKeyExist(lngRootKey, "Software\AAA-Registry Test\Products") Then
...
' --------------------------------------------------------------
  regCreateKeyValue lngRootKey, "Software\AAA-Registry Test\Products", _
...
' --------------------------------------------------------------
  strKeyQuery = regQueryAKey(lngRootKey, "Software\AAA-Registry Test\Products", "StringTestData")
  strKeyQuery = regQueryAKey(lngRootKey, "Software\AAA-Registry Test\Products", "NumericTestData")
...
' --------------------------------------------------------------
  regDeleteSubKey lngRootKey, "Software\AAA-Registry Test\Products", "NumericTestData"
...
' --------------------------------------------------------------
  If Not regDeleteAKey(lngRootKey, "Software\AAA-Registry Test", "Products") Then
      MsgBox "Failed to delete requested subkey!    ", vbOKOnly + vbExclamation, "Registry Key Delete"
      GoTo Normal_Exit:
  End If
  
  If Not regDeleteAKey(lngRootKey, "Software", "AAA-Registry Test") Then
