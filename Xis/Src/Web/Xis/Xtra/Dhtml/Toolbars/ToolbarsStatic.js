...
function TBLayoutBodyElement() {
  ...
  tbContentElementObject.style.left = 50; 
  tbContentElementObject.style.posHeight = 350;//document.body.offsetHeight - tbContentElementBottom - tbContentElementTop;
  tbContentElementObject.style.width = 575; //document.body.offsetWidth;
